...
def add_biomass(n, costs, beccs, biomass_import_price):
    ...
    if beccs:
        ...
        n.madd("Link",
               ...
               efficiency3=costs.at["biogas", "CO2 stored"] * (1 - costs.at['biogas', 'capture rate']) - costs.at['gas', 'CO2 intensity'],
               p_nom_extendable=True)
        ...
        n.madd("Link",
               ...
               efficiency3=(costs.at['gas', 'CO2 intensity'] + costs.at["biogas", "CO2 stored"]) * (1 - costs.at['digestible biomass to hydrogen', 'capture rate']),
               p_nom_extendable=True)
                ...
                if snakemake.config['biomass']['lowT industry steam biomass']:
                    n.madd("Link",
                           ...
                           efficiency2=costs.at['solid biomass', 'CO2 intensity'] * (
                                   1 - costs.at["cement capture", "capture_rate"])-costs.at['solid biomass', 'CO2 intensity'],
