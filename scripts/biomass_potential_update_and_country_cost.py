...
######## Read in data from ENSPRESO and add to biomass costs
    ...
    excel_out = excel_out.rename(index={'MINBIOAGRW1': 'straw',
                                        ...
                                        'MINBIOSLU1': 'sewage sludge',
                                        'MINBIOCRP41': 'willow poplar'}).sort_index()

    year = 2040
    scenario = 'ENS_Ref'
    # biomass_country_costs = {}

    cropsToAdd = ['straw','forest residues','manureslurry','municipal biowaste','sewage sludge','industry wood residues','landscape care','willow poplar']
